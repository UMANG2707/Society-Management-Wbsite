					...
					<div class="col-md-8 col-md-offset-2 col-sm-12">
						<div class="office-contact-form">
							...
							<div class="contact-form">
								<form method="post" action="db-forgot-admin-pass.php" autocomplete="autocomplete">
									<input type="text" class="form-control" placeholder="Society_Code *"  name="sc" required="required"><br>
									<input type="date" class="form-control" placeholder="Birth Date *"  name="bd" required="required"><br>
